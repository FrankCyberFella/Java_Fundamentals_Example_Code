...
// This is an application program because it has main()
// main() is the starting point of the application
// main() controls application processing
// In OOP (Object-Oriented Programming) the application instantiates, uses and manipulates objects

	public static void main(String[] args) {

		CardDeck myDeck = new CardDeck();
		//CardHand myHand = new CardHand();  // Cannot instantiate a CardHand as it is an abstract class
		...
		System.out.println("-----------------------------------------------------");
	  	//      since its defined as static we can code:     enum/class-name.enumValue
...
/************************************************************************************
 * "Helper" methods that main() call follow the end of main
 *
 * Must be static because main() static
 *************************************************************************************/
//**********************************************************************************
...
//**********************************************************************************
	 ...
	 * @return
	 */
	// This method must be static because it is called by a static method - main()
